...
class BookTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Book');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Publisher', '\\App\\Models\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Book) { // it's a model object
