...
class PublisherTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Publisher');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Book', '\\App\\Models\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Publisher) { // it's a model object
