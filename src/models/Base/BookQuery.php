...
use \Exception;
use \PDO;
use App\Models\Book as ChildBook;
use App\Models\BookQuery as ChildBookQuery;
use App\Models\Map\BookTableMap;
 ...
 *
 * @method     \App\Models\PublisherQuery|\App\Models\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Models\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Models\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Models\Publisher object
     *
     * @param \App\Models\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByPublisher($publisher, $comparison = null)
    {
        if ($publisher instanceof \App\Models\Publisher) {
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \App\Models\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Models\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\App\Models\PublisherQuery');
    }
