...
use App\Models\Publisher as ChildPublisher;
use App\Models\PublisherQuery as ChildPublisherQuery;
use App\Models\Map\BookTableMap;
use App\Models\Map\PublisherTableMap;
...
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Publisher object.
     */
     ...
     * @return $this|\App\Models\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Publisher'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\App\Models\Book');
    }
